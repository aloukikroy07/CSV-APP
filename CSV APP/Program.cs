       ...
       public static void Main()
        {
           //Connect To Database
            ...
            connect.ConnectionString ="Server=SUH-2:30015;UserID=DBSFO;Password=Db$F0#952";
            ...
            if (System.IO.Directory.Exists(exportPath))
            {
                ...
                try
                {
                    ...
                    while (newReader.Read())
                    {
                        ...
                        string sqlText = @"SELECT ""U_DocNum"", ""U_ItemCode"",  ""U_Quantity"", ""U_Price"", ""U_TaxCode"", ""U_BatchNo"", ""U_BatchMfgDate"", ""U_BatchExpDate"", ""U_UomCode"" FROM ""SFO_PROD"".""@T002"" WHERE ""U_DocNum""='"+newReader[0]+"'";
                        ...
                        while (reader.Read())
                        {
                            ...
                            csvFile.WriteLine(String.Format("\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\",\"{7}\",\"{8}\"",
